...
export default function Tenants() {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            loadTenants();
            setFormData({ full_name: '', national_id: '', phone: '', email: '', move_in_date: '', property_id: '', house_id: '' });
        } catch (err) {
            alert(`Error ${isEditMode ? 'updating' : 'creating'} tenant: ` + (err.response?.data?.error || err.message));
        }
    };
